 ...
 * 文档列表类
 *
 * @version        $Id: arc.listview.class.php 2 15:15 2010年7月7日Z $
...
class ListView
{
    ...
    function GetPageListST($list_len, $listitem = "index,end,pre,next,pageno")
    {
        ...
        if ($totalpage <= 1 && $this->TotalResult > 0) {
            ...
            return "<span class=\"btn btn-secondary disabled btn-sm\">共 1 页" . $this->TotalResult . " 条记录</span>\r\n";
        }
        if ($this->TotalResult == 0) {
            return "<span class=\"btn btn-secondary disabled btn-sm\"> 对不起，没有记录！</span>\r\n";
        }
        $purl = $this->GetCurUrl();
